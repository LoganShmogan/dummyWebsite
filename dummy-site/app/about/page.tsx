    ...
    <div className={styles.container}>
      ...
      <section className={styles.missionSection}>
        <div className={styles.sectionHeader}>
          ...
          <p>
            The mission of Happy Horizons is to foster a love of learning and a
            sense of wonder in every child. We provide a caring, engaging, and
            inclusive space that encourages curiosity, creativity, and
